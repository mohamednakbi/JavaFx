...
//        System.out.println(c.toString());
    ...
    public void mailSender() {
        String host = "mohamednakbi16@gmail.com";  //← my email address
        final String user = "mohamednakbi16@gmail.com";//← my email address
        final String password = "mohamed.040416590123";//change accordingly   //← my email password

        String to = "mohamed.nakbi@esprit.tn";//→ the EMAIL i want to send TO →
